...
//                UiUtils.setStatusBarColor(activity);
                break;
        }
    }
    ...
    public static boolean isMiUi(){
        if(RomUtils.getLightStatausBarAvailableRomType()==RomUtils.AvailableRomType.MIUI){
           return true;
        }
        return false;
    }
    ...
    public static boolean isFlyme(){
        if(RomUtils.getLightStatausBarAvailableRomType()==RomUtils.AvailableRomType.FLYME){
            return true;
        }
        return false;
    }
