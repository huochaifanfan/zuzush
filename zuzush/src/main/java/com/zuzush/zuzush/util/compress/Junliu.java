package com.zuzush.zuzush.util.compress;
...
public class Junliu implements Handler.Callback {
    ...
    private Junliu(Builder builder) {
    ...
    public static class Builder {
        ...
        private Junliu build() {
            return new Junliu(this);
        }
